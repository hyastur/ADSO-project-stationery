# Papelería Todo Arte - Sitio Web y Sistema de Gestión

Este software está siendo desarrollado como proyecto formativo para el tecnólogo en **Análisis y Desarrollo de Software (ADSO)** del SENA.
...
*   [ ] **Catálogo Virtual:** Visualización organizada de productos por categorías (Arte, Escolar, Oficina).
*   [ ] **Gestión de Inventario (CRUD):** Permite al administrador crear, leer, actualizar y eliminar productos.
*   [ ] **Módulo de Contacto:** Formulario funcional para cotizaciones o pedidos especiales.
